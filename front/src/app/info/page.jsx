    ...
    const features = [
      {
        ...
        backContent: (
          <div className="space-y-3">
            <h4 className="text-lg font-semibold text-purple-300">Funcionalidades</h4>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <span className="text-purple-400 mt-1">✓</span>
                <div>
                  <strong>Panel de Progreso</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-400 mt-1">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-400 mt-1">✓</span>
                <div>
                  <strong>Integración con Google</strong>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <strong>Respuestas Contextuales</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400 mt-1">✓</span>
                <div>
                  <strong>Ejemplos de Código</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400 mt-1">✓</span>
                <div>
                  <strong>Explicaciones Paso a Paso</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400 mt-1">✓</span>
                <div>
                  <strong>Restricción por Lenguaje</strong>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <strong>Pruebas Personalizadas</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-400 mt-1">✓</span>
                <div>
                  <strong>Refuerzo Semanal</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-400 mt-1">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-indigo-400 mt-1">✓</span>
                <div>
                  <strong>Retroalimentación Instantánea</strong>
                </div>
              </li>
            </ul>
          </div>
      ...
      },
      {
        ...
        backContent: (
          <div className="space-y-3">
            <h4 className="text-lg font-semibold text-green-300">Elementos de Juego</h4>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <div>
                  <strong>Tablas de Clasificación</strong>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <div>
                  <strong>Juegos por Conceptos</strong>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div ref={containerRef} className={`relative w-full h-full transition-all duration-1000 ease-[cubic-bezier(0.4,0,0.2,1)] ${isFlipping ? 'opacity-0 scale-x-0' : 'opacity-100 scale-x-100'}`} style={{ transformOrigin: 'left center' }}>
          ...
          <div className={`container mx-auto px-6 py-24 max-w-6xl transition-all duration-700 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${isMounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
              <Typewriter
                words={["La plataforma donde aprender programación se convierte en una aventura interactiva, con IA especializada y seguimiento personalizado."]}
                loop={1}
                typeSpeed={40}
                ...
                {[1, 2, 3].map((step, i) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-cyan-300">
                      ...
                      {step === 2 && "Estudiantes aprenden"}
                      {step === 3 && "Seguimiento automático"}
                    </h3>
                    <p className="text-purple-100">
                      {step === 1 && "Los profesores acceden con Google y configuran sus clases con estudiantes."}
                      {step === 2 && "Interactúan con IA especializada por lenguaje y juegan para reforzar conceptos."}
                      {step === 3 && "La plataforma genera tests y estadísticas para profesores y alumnos."}
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="relative p-8 rounded-3xl overflow-hidden bg-gradient-to-br from-purple-900/40 to-cyan-900/30 border border-cyan-500/30 mb-16 group hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-500">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8 transition-all duration-500 group-hover:translate-x-2">
                  <h2 className={`text-3xl font-bold mb-4 text-cyan-200 ${styles.fadeInLeft}`}>🎮 Zona de Juegos</h2>
                  <p className={`text-lg text-purple-100 mb-6 ${styles.fadeInLeft}`}>
                    Nuestra sección gamificada transforma conceptos complejos en desafíos divertidos. Los estudiantes ganan puntos, insignias y suben de nivel mientras dominan la programación.
                  </p>
                </div>
